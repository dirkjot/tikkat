...
def generate_updates_for_states(slackclient, states=all_states, count=100):
...
def airtable_update_completion(updategen, tickets_table):
    ...
    for upd in updategen:
        if upd.table != 'tblA4zbHiw2Lqyvzo':
...
if __name__ == "__main__":
    airtable_update_completion(
        generate_updates_for_states(slackclient, count=500), 
        tickets_table)
